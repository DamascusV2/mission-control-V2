...
export default function IntelPage() {
  return (
    <div className="space-y-6">
      <div>
        <p className="text-xs uppercase tracking-[0.3em] text-white/50">Intel Feed</p>
        <h2 className="text-2xl font-semibold">Signals</h2>
      </div>
      <div className="space-y-4">
        {intel.map((item) => (
          <div key={item.id} className="bg-panel rounded-2xl border border-white/5 shadow-panel p-4">
